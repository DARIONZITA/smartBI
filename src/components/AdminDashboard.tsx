...
export function AdminDashboard({
  ...
  const renderNavItem = (item: any, isActive: boolean) => {
    ...
    return (
      ...
      >
        <Icon
          className={`w-4 h-4 sm:w-5 sm:h-5 flex-shrink-0 ${isActive ? "text-dark-primary" : "text-dark-secondary"}`}
        />
                ...
                <div className="dark-card p-4">
                  <div className="flex items-center space-x-3">
                    ...
                    <div className="min-w-0">
                      <h3 className="text-xl sm:text-2xl font-bold text-dark-primary">
                        2.4GB
                      </h3>
